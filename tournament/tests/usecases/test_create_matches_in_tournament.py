...
class TestCreateMatchesInTournament(TestCase):
    ...
    def test_create_matches_player_(self):
        storage = mock.Mock()
        presenter = mock.Mock()
        ...
        tournament_player_usernames = []

        for match in create_matches_data:
            player_usernames = match['player_usernames']
            for username in player_usernames:
                self.assertNotIn(username, tournament_player_usernames, 'Player should have a unique match')
            tournament_player_usernames.extend(player_usernames)
