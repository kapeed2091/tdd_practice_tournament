...
class TestListAllTournaments(TestCase):
    ...
    def test_list_tournaments_for_non_registered_user(self):
        from tournament.models import KOTournament, UserProfile
        from ib_common.date_time_utils.get_current_local_date_time import \
            get_current_local_date_time
        import datetime
        ...
        user_id = 'user_1'
        non_registered_user_id = 'non_user_1'
        t_id_1 = '1'
        t_id_2 = '2'
        tournament_name_1 = 'tournament_1'
        tournament_name_2 = 'tournament_2'
        ...
        with self.assertRaisesMessage(Exception,
            ...
            KOTournament.get_all_tournaments(user_id=non_registered_user_id)
