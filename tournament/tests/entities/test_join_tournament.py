...
class TestJoinTournament(TestCase):
    ...
    def test_join_tournament(self):
        self.tournament_obj.join(username=self.USERNAME)
        self.assertIn(self.USERNAME, self.tournament_obj.player_usernames,
                      'User did not subscribe')

    def test_join_tournament_for_duplicate_username(self):
        self.tournament_obj.player_usernames.append(self.USERNAME)
    ...
    def test_join_tournament_to_check_maximum_count(self):
        ...
        self.tournament_obj.player_usernames.extend(subscribed_usernames)
